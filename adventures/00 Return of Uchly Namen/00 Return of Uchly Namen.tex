...
\thispagestyle{empty} %set empty, no footers or headers
\fancypagestyle{plain}
...
I've tried to balance the encounters to fit a group of a few 100xp newbies character, straight rolled and without serious optimization beyond what is recommended in the campaign section of the rulebook.
...
If you run this campaign for a larger group, more experienced players, or better characters please adjust the opposition. The easiest way is to just increase the amount of critters, or upgrading a couple of them to more potent variants. Most maps have nooks and crannies where reinforcements or hidden reserves can be spawned without breaking the logic of the encounter. Also, if the enemies are overwhelmingly difficult, just delete some of them.
...
The different sub-quests are designed to showcase different tactical issues with the hactac rule set and world. The combat power of new player groups vary quite a bit so it's likely that the encounters need to be adjusted to suit your particular group of murderers. Also, veteran tabletop players will probably be better at the early stage optimization of their characters, which means their characters will have more combat prowess per XP than characters created by newbie players.

\

The first run through of the campaign was 2009-12-02 to 2010-05-17. It took a total of 21 weekday evening sessions, of 2-3h each. Our total game time was around 50h. The early sessions had some technical issues that took some time, but all in all the MapTool-1.2-b32 worked quite well, as did Jarnal-917. We started out with skype for voice chat but had to switch since it was way too unreliable and problematic. Teamspeak3 worked much better, but with some minor issues regarding latency. Mumble should be a great replacement, but has not been tested yet. \emph{In late 2017 we run exclusively with mumble and mostly with MapTool-1.4.0.5, with Jarnal not used for a while.}
...
If they cannot find all three gems: RedStone, GreenStone, BlueStone, and bring them to her before the end of the summer, the Demon of Old, Uchly Namen, will rise again. As he did once before, he will lay waste to the region. This happened already some 200 years ago, and the stars are coming into alignment for it to happen again. She must rebuild the binding artifact to prevent the demon from entering this realm.

Now, if the heroes would please be so kind as to find all three gem stones and bring them to her, she will take them to the gate site to "sacrifice the binding artifact" and close the gate \emph{forever}!
...
\item[intermission] Rest and recuperate. Decide whether to continue helping Dyslexia Marigt for some more gold. Perhaps figure out that Dyslexia Marigt is planning on using human sacrifice in her "gate sealing" ritual.
...
\item[RedGuard:] Conq's elite guards. They are dangerous in a fight since they can make multiple accurate attacks with their wicked sharp staffs. Other than fighting they are mostly silent and somber.
...
The advertisement is tattered and worn, but it is the best thing available. The Heroes gather their meager belongings and buy passage on a ship the very next day. After a short and sunny cruise the Heroes finally disembark on the pier of Sleepy Cove harbour, late on a beautiful summer's day.
...
Dyslexia Marigt looks real angry, but composes herself fast. She looks at the heroes and smiles:
\begin{readoutloud}
...
I found out about the demon when I worked for the Baron Conq a few months ago. I was hired to organise and update his family library and chronicles. There was a mention of a horrendous event some 200 years ago. I have since, through long and painstaking research, found that it was the arrival of a powerful Demon, "Uchly Namen", that caused the chaos. Unfortunately the information is a bit uncertain and incomplete in places. But I believe I've found a way to, once and for all, seal the gate through which the demon enters this world.

I have here an artifact, which, when complete, can be used to seal the gate forever. Will you please help me acquire the three missing crystals?

The first, the RedStone, has been stolen by some goblin bandits, I believe.
It was over a month since I sent out the request for heroes and I already hired a couple two weeks ago. They set out towards the Dread Duns of Doom, south of the moors, but have since vanished.

I heard a rumour that they had been sighted moving north over the moors, in good health. That was about a week ago.
...
The third, the BlueStone, is in the claws of a villainous old sorcerer, Ho-Bliz Wayze, who lives in the old dark and decrepit tower of his evil ancestors, on the border of Baron Pawa's domain.

He has refused to sell me the stone, even if I have offered a fair price for it. I even told him of it's importance, and he still will not see reason and sell it to me.
...
Now, will the heroes agree to this? 5+5+5+15 gold is a lot of money, 10g each if they are three people, and then the possibilities for extra loot. This is more money than they have ever had in their life before.
...
If you do not have any skill in tracking, I suggest you hire yourselves a guide, or it will be difficult to find the bandits. You might be able to hire John AllBeard for a couple of coppers per day, as long as you don't expect him to do any fighting. Then he will charge you a lot.
\end{readoutloud}


Evilnius Conq has set a RedGuard to protect, and control, Sneexious. She presents him as her body guard here on the outskirts of civilisation.


Bling SwordSlash will be in the "Sleep with the Fishes" most of the campaign after leaving Dyslexia Marigt. He is very full of himself, and likes the eager attention of all the naive girls in the village. And they look so much alike, he doesn't even have to bother remembering who is who.


\subsection*{The General Store}
%------------------------------
Being the only source of commerce in the village, the store charges 20-33\% above list price on just about everything. He has most of the simple basic equipment in the list, but only a 10\% chance of carrying anything special and nothing exotic.
He will also purchase second hand equipment at very low rates. Good gear at most 50\% value, goblin stuff at around 10\% value, if at all.


\subsection*{The "Sleep with the Fishes" inn}
%--------------------------------------------
This is the social centre of the village. There are almost always some people here, and it is a great place to do some gossipping to find out what is going on.

After the first day, Bling SwordSlash will be in the inn most of the time, usually surrounded with by a flock of village girls.
...
He cleaves the horse in two when the farmers argue about it. He kills a whole family to drive out a werewolf: "Just to be safe!". He burns the food store in the middle of the winter in order to kill an Ice Murkler which had been terrorising the village. He kills both twin sisters when he can't be certain about which one is the evil twin.
...
balance     3                1.0   9
quick draw  6                0.5  18
avoid       8 yield+4        0.8  51
sharpstaff 12                1.0 144
whirlwind   7                1.0  49
shield      6                0.7  25
resilient   7                1.0  49
enduring    2                1.0   4
...
sharpstaff   12 dam 6/7(5/6), penetrating 1, abs 15, parry+0/+1,
(1h/2h)         reach 1 mod-3, finesse-4
                str 5 (max +2 str bonus, extra str bonus are penetrating)
                2h: fast+1 with str 6 and dex 6
...
paralyse     6 cast 2r 2m, +1target/2m, range 10 +5/m, duration 2r +1/m
               ...
               on cast).
               int 7, psy 9
fear         6 cast 1r 1m, psy \vs psy +2/m, range 5 +2/m, area aura,
...
fasionable legendary plate mail abs 3 (behaves as brigandine)

Bling is too cool for stats, and I'm lazy. He has around 1000xp and a couple of super abilities, like Über, and a lot of powerful fighting skills and maneuvers.
...
\subsection*{Synopsis}
%---------------------
The Heroes will hopefully ask around in Sleepy Cove before setting out to find the Goblin Bandits. The Goblin Bandits will be found in the west parts of the South Woods. The heroes will slay the Goblins, or some might run away. In the cave they will find the bodies of Dyslexia's earlier hirelings. In the Goblins treasure they will find the RedStone.


\subsection*{First piece, the RedStone}
%--------------------------------------
It has been taken by goblins. Dyslexia's previous hirelings, a couple of adventurers, went to the Dread Duns of Doom in the south to retrieve the RedStone, and were spotted traversing the moors northward a few days later alive and well. Then disappeared passing through the south forest.
The adventurers are now rotting in the eastern section of the goblin bandits' cave. Hidden in the woman's skirt, in a secret pocket is the RedStone.
...
\begin{readoutloud}
This is an open area of the forest, but the faint stench of goblins and wood smoke is drifting amongst the trees. You can barely make out some gibberish and occasional yells further north east.
\end{readoutloud}

The goblin bandits are resting around their fire when the heroes enter the map. They are all unaware, and will only notice the approaching heroes if they fail their sneak rolls.

\begin{readoutloud}
The Goblin Bandits are sitting around a camp fire, chattering in their goblin gibberish tongue. They seem relaxed, but have weapons close at hand.
...
The goblins will retreat to the left in the cave, wake their sleeping friends and make an ambush. The first wounded will flee further in to free the wolf. Freeing the wolf takes one round. Then they charge behind the wolf. If it doesn't go well they will try to flee out of the cave.
...
\small\begin{verbatim}
bandits 8x: 3x spears, 2x short sword+shield, 3x short bow + knife
...
small shield   6 abs 10, parry+2
throwing knife 5 dam 3, fast+1, readied as quick draw in the belt.
...
%-------------------------------------------
\begin{readoutloud}
The mining village of Eisenkrafs is the place where decent civilisation has gone to die, and rot, and smell really really bad. Inhabited by the desperate, the poor, the destitute, the vicious, and the foul, this village is very close to the bottom of the list of summer vacation spots. Small wood huts and hovels are crowded around a few decent houses. The place reeks of desperation and apathy. Even the dark slow smoke leaving the many poorly laid chimneys has lost all hope and energy.
\end{readoutloud}


\subsection*{Eisenkrafs village}
%-------------------------------
Eisenkrafs is a horrible little mining town. It is run by Gebbhard Goebbels, foreman of the mine. It is still within the lands of Baron Evilnius Conq, and he does get some taxes from the place, although most of the money disappear into the hands of Goebbels and his folks, a local bandit gang, and some iron merchants in league with Goebbels.

Purchasing food and beer can be done at the "beer house", along with some every day stuff. Equipment, etc, can be purchased from the mining yard. Prices are double the list values. Non essential stuff, not necessary for mining and living has only about 50\% chance of being available.
...
Shaft 5-1 has been closed for years since it opens into a natural cave system which is very deep. Too dangerous to work excavation.


\subsection*{Investigating}
%--------------------------
A good way is to start asking around in town about Coal-Black-George. Most people knew him as a good miner, "some orc and dwarf blood in those veins I'm sure." He worked hard, drank less than most, and worked even more in shut down tunnels, caves, etc.
...
+4 Coal-Black-George had found some strange green crystal a while back. \\
...
%-------------------------------------------------------
Gebbhard Goebbels will contact the Heroes once he finds out that they are asking around in town. He will say the old warrens and closed down areas are swarming with horrible creatures. That it is certain death to go down there.
...
This will take be 10 climb+3 rolls. If they have rope it is climb+6 rolls, and with proper climbing gear it is climb+9.


\subsection*{Below Shaft 5-1 : The Natural Cave}
%-----------------------------------------------
\begin{readoutloud}
As the last of you steps off the rope ladder leading up through shaft 5-1 you hear a rustling from above the shaft. All of a sudden the ladder is falling down, coiling around your feet. A few seconds later the way up and out is nothing but a large pile of rope, and the weak lantern light coming down from above dims and disappears.
...
Climbing back up is not that difficult, mod+3. Roll 10 successful climb without falling down. This is made easier if they bring climbing gear to fasten safety rope, or they can improvise with daggers and rope.

If the heroes manage to get back up from the cavern, they will probably know that George was murdered, since there is a knife sticking out of his back. They might even have a suspicion of foul play from Gebbhard Goebbels and his ruffians since the ladder disappeared.
...
The heroes should be made clear, at least after a little fighting, that they will not be able to fight their way through all the miner ruffians. Instead they will have to retreat down the cave again.
...
The heroes should each get a 10XP sub quest reward once they have delivered the Green Stone to Dyslexia Marigt. Add another 5XP each if they managed to figure out the back story around Gebbhardt Goebbels and either avoided or dealt with that problem.
...
\small\begin{verbatim}
1 Gebbhard Goebbels - the mine Boss
4 Miner Ruffian
4 Cave spider
11 Bug
1 cave worm
...
avoid     3 yield+2
-----------------------------------
Since the web attack opens the spider to counter attack they are cautius to use them. They try mainly when there is low risk of counter attacks.
...
A broken Banor's Gate can be found in the tower. The transaxial relocator is broken so the device has a 30\% chance of loosing the link after each usage. Honorbliz Wize was trying to repair it for a team of adventurers, but was killed before he could finish.
...
%-----------------------------------
\begin{readoutloud}
As you approach the wizards dark abode you hear screams and see flashes of light from the east base of the tower. A wizard and a hooded figure are doing battle.
\end{readoutloud}
...
Sam triggered a couple of defensive runes when entering the tower, and had to flee fast. Honorbliz reacted with the traditional "I'll kill him myself" nonsense and went out unprepared onto the steps of the tower. There he proceeded to get poisoned by a throwing knife, taking some hits, and not managing to blast Sam into oblivion. Sam is quite tough.

The battle unfolds approximately like this: \\
Round 1: \\
As soon as the heroes see Sam Slick: \\
\emph{expose the fireball} \\
Sam tries to evade, is burnt and his cloak keeps smoldering afterwards. \\
Round 2: \\
...
Do not let Honorbliz Wize survive. The heroes should not be able to heal him. If they try, he has cast a powerful protective spell on him which will easily dispell their healing magic, rendering it ineffective and fizzling out in showers of bright sparks. He should deliver the line about Sneexious' greed, then pass out and die.
If he is allowed to live he will simply go to Sleepy Cove, kill or imprison Sneexious and the adventure is over. So, don't let him survive.
...
\end{readoutloud}
He will start to cast a spell, but collapses and passes out, or dies.
...
\begin{readoutloud}
\emph{Dining hall:}
The dining hall is spacious and elegant. This must be what a wizard's tower looks like. Elegant furniture, exquisite china, good taste in decoration, pleasant atmosphere. It must be, since there is a wizard living here. The strange magical shadowy servants might be a good indicator of course.
...
%-----------------------------
\begin{readoutloud}
The first floor is spacious, light, and well decorated. A large cluttered desk draws the eye, as does the two beautiful statues that decorate the room, the nice rich carpet, and the simple but elegant bed.
\end{readoutloud}

The BlueStone is in a drawer in the desk (find+3). It is lying way back in a dusty old corner, behind and below a lot of junk from the last 200 years. Beside it is a notebook about the battle, (literate) explaining that the demon was vanquished by the lance spear and shield now hanging in the Pawa hall. Demon hunting was never an interest of Honorbliz, so he didn't take much time to research the event. He managed to figure out that the necklace is the summoning and controlling device. He didn't want to destroy a nice artifact, it could come in handy, so he just took it apart and teleported the parts to "well protected places"; a sealed crypt, a cave in the middle of nowhere, and kept one stone to himself. The necklace piece itself didn't really contain any power, so he sold it for the gold value, a nice 100gold or so. He also describes the demon beast Uchly Namen as a large green humanoid demon with glowing eyes. (int) figures out that it is the one depicted on the tapestry in the dining hall.
...
\textnormal{+0:} Honorbliz Wize, William GreatClub, Drenchdin Blood, and Marco Cardigan has formed a heroes' possee to slay or banish the Demon Foe. \\
...
The desk also contains a small silver box. Touching the box gives a shock dam 4, and significant immediate passing pain. The user must roll a psy mod-3 to maintain hold of the box, and cannot do it on the first attempt. The box contains 6 gold 14 silver and 122 copper, 1 ruby worth 2 gold.

Three Time Flies can be found on the east statue. Identify with int-3 roll, figure out how to use with int-6 roll. They are still uncondensed and weighs 1.0 enc, and requires 2hp damage to break. Which means they can only be used by holding (or quick draw) and throw into the ground rolling 2 or more on str/3 round down. They should be condensed and set in a light leather necklace or some such. Condensing and setting them costs about 1gold each. They can be sold for about 2 gold each in the current state.
...
A large broken Banor's Gate artifact can be found here. Identify on int roll. The transaxial relocator is broken, and is in three pieces on the western work bench. It requires an int roll to figure out that the three pieces can be assembled and go into the artifact.
...
feint
----------
2x fast blades   10 dam 6(5), abs 8, fast+1
...
poisoned              range 8, short 4 mod+3, long 12 mod-3,
                      ...
                      poison is paralyzing and damaging
                      strength 12, dam is str vs con diff: 1hp/rnd,
                      paralyzed for 3r per diff.

Amulet of Freedom. Counters magic that hinders the movement of the bearer.
Will also unbind rope knots and unlock shackles that bind the bearer.
...
----------
quick         3 (0,0,-3,-6)
claw          8 dam 2 penetrating, 1 icy cold pain, 1 attack per round max.
avoid         9 dissolve and reappear, weapons passing like through smoke
...
If the Heroes refuse to give her the stones before full payment she whines a bit, but then gives them a piece of jewelry to hang on to as collateral. It looks worth at least 10-20 gold but it is a well made fake worth about 3 gold. It is an "appraise" mod-3 roll to spot the fake.
...
When Sam enters the Sleeping with the Fishes to speak to the Heroes, Bling SwordSlash is there as well. Bling nods to Sam, saying a short "Sam", in a displeased manner. Sam in turn nods to Bling, saying a short "Bling", also not pleased.
...
\subsection*{If the characters decline "guarding" for the "gate closing"}
%------------------------------------------------------------------------
...
The village will be terrorised when they find out, and ask for help. Bling SwordSlash will request 100 gold, and the village can't pay. The Heroes will be offered 20 gold to find and bring home the missing women.

Where to start? No one knows. Except Sam Slick, who can be found at the inn in the morning. He will offer to sell them the information for 15 of the 20 gold (can haggle down to 10). He did spy on Dyslexia Marigt and saw an opportunity to score some money when she went out kidnapping the women and leaving in the dead of night.
...
\subsection*{Synopsis}
%---------------------
The Heroes return to Eisenkrafs to take avenge on Gebbhardt Goebbels and his minions. They seek him out and fights him. Then they escape with some loot perhaps?


\subsection*{Taking Revenge}
If the heroes do want to take revenge on Goebbels et. al. then let them. In chapter two, when they were just weak newbies it was not likely that they would succeed in fighting their way up through the mines, but after another batch of XP from the lower levels of the caves, as well as perhaps the wizard's tower and all the riches it holds it might be possible to make a raid into Eisenkrafs to kill Goebbels and perhaps some of his minions too.

Gebbhardt Goebbels will be in the mine yard most of the day, with some short trips into the mine. He will be in his house all evening and night. During the night there is 33\% chance that a runner from the Eisenkrafs Bandits will contact him (sneak 10).

The trick to a clean kill is to get at Goebbels when there are few people around him. If the characters walk around town asking for him he will hear of it very soon. If they just hang around he will hear about it the next day, and if they sneak around he might not find out. When Goebbels finds out about them he will take a group of ruffians with him and confront them, being nice but careful in the beginning. It will likely escalate and he has no scruples about killing the Heroes. He will also call in reinforcements again and again.

\subsubsection*{The mine yard}
Assaulting Goebbels in the mine yard office is a possible heads on approach. Killing Goebbels is not that difficult. He is good with the pick axe, but does not have good defence. However, he can call 5-10 miner ruffians from the mine yard to help him in 1-3 rounds, and another 10+ miners and orcs from the mine entrance 10 rounds after that.

The mine yard office has a total of 8 silver and 24 copper in a couple of pouches locked away in the desks.
Gebbhardt also has the key to his house if searched (find roll on the corpse).

\subsubsection*{The streets}
Intercepting Goebbels when he is walking through town is possible if they spy on him. He might have 1-3 ruffians with him, and can call in reinforcements in 15-20 rounds. If he is aware of the Heroes presence in Eisenkrafs he will have a much larger force with him, and reinforcements in about 10 rounds.

\subsubsection*{Goebbel's house}
Breaking into Goebbels house in the middle of the night is another way. He will be asleep, but his servant wakes very easily and will sound the alarm immediately. Reinforcements can arrive in 30+ rounds.
The door is locked mod-3 and sturdy abs 8 hp 50. The window shutters are barred mod+3 and sturdy abs 3 hp 10. They are also small and require a dex to climb through.

The house itself is holds about 100enc of loot that is valuable enough with a total value of about 10 gold. Best appraise success can give about 10enc of 3sm/enc.
...
\begin{readoutloud}
The trap door ladder is a bit longer than expected, and it leads down to ancient stone set walls, with centuries of slow mineral deposit buildups. You get an eerie feeling crawling down the spine. This might be dangerous.
\end{readoutloud}
...
In the chests the heroes can find a fine sword mod+1 abs+5 worth about 10 gold, as well as two unused sentinel bases (charge 10, skill 7, dam 4, enc 5) worth 3 gold each. A total of 12 gold 42 silver and 230 copper is also available. The chests are locked mod-0 sturdy abs 4 hp 10.


\subsection*{Getting away}
Regardless of their success in the killing the Heroes can count on problems on their way back. The towns people might be problematic. If they figure out that Goebbel is dead a few will try to avenge him. If the Heroes are carrying loot from Goebbel's house there will be lots of greedy miners who will assault them with rocks, slings, bows, etc, as well as pick axes, spears, etc.

Once the Heroic few manages to escape Eisenkrafs they will be tracked down by the bandits if the rumour is that they have taken anything of value from Goebbel's house. The Bandits will make an assault at night. However they will not pursue south of Castle Conq.
...
str  12   hp 17 abs 0
dex  6    m1 w3 r6 d9
int  3    vision 15 dusk
psy  3    mana 2
per  2    initiative 8
----------
avoid     5 yield+3
----------
2h pick axe  5 dam 10(8), penetrating 3, abs 6, parry-3, slow-2
               or dam 8 slow-1
money ( 0g 0s 3c)
===================================
...
yield     +3
----------
axe        7        dam  7, abs  8, parry -3,
                    str 4 (max +3 str bonus), finesse-3
shield     7        abs 12, parry +3, str 4
...
short sword   4     dam  5, abs 8,
                    ...
                    str 3 (max +1 dam str bonus, max +1 penetrating str bonus),
                    finesse-5
bow        7      dam 5,
                  range 16, short 8 mod+3, long 24 mod-3,
...
%            TODO:   add section on raiding the Eisenkrafs Bandits

%-------------------------------------------------------------------------------

\subsection*{Raiding the Eisenkrafs Bandits}
If the characters have managed to get in on the good side with the Eisenkrafs townsfolk, or managed to track down the bandits' stronghold, they can attempt to raid the place and make off with some nice loot.

The Bandits' camp and cave is east of Eisenkrafs. The place probably has only a few guards now that the Heroes have already slaughtered their main force during the assault  ?
...
\clearpage
\phantomsection\addcontentsline{toc}{section}{04 the gate}
\section*{04: The Summoning -- The Gate Site}
...
The Summoning Site is 14-19 steps from Sleepy Cove depending on path.


\subsection*{If the heroes have come with Dyslexia Marigt as guards}
%-------------------------------------------------------------------
First out, a second RedGuard is waiting for them at the site. He says:
\begin{readoutloud}
[gruff stern voice]: Welcome Sneexious. The ritual site is clear and safe.
\end{readoutloud}
This is surprising, why would she need another guard if she just hired the Heroes?

Dyslexia Marigt goes to the altar podium, and asks the heroes to stand close "so that they will be safe during the ritual."

She then starts performing the initial steps of the ritual, which takes a few minutes. Nothing much happens.
She then casts slow, first, (to get better access since she is not as good with paralyse). Then she casts paralyse.
Roll for int to see if the heroes realize that she it not working on the ritual any more when she is starting to cast slow and paralyse.
Once slowed or paralysed the RedGuards will move in to grab the heroes and bring them to the altar.

If they get slowed and paralysed by Dyslexia Marigt, Sam Slick will show himself and require 10 gold or the Banor's Gate they stole from Honorbliz Wize's tower as payment to help save them.
If agreed he will throw a Blast Off! at Dyslexia Marigt, stunning her with the shock, and forcing her to target him instead of the held helpless Heroes.
He will battle Dyslexia and the guards until he is at 50\% hp, then he will flee, hoping the Heroes have managed to escape.
During this time the heroes will break free on a successful psy roll.

If they don't escape immediately the demon will still come through after a while, and then they really must escape.

Dyslexia Marigt will shout at them that they are imbeciles and fools. Without the sacrifice he will be uncontrollable. He will lay waste to the entire region! Death to all.


\subsection*{If the heroes have come after Dyslexia Marigt, to free the girls}
%-----------------------------------------------------------------------------
Sam Slick has come with them to see what is going on. He will show them the site, but not fight. If they get into trouble he will offer to help them out for 10 gold.

When they arrive Dyslexia is on the podium altar, chanting away. The girls are bound down lying on the altar. The two RedGuards stand by the podium on guard.

The heroes now have a short while to try to get the girls free somehow. They can try to lure away the guards, or attack them from a distance, or attack Dyslexia directly somehow. Then they can try to grab a girl and run off with her.

It will probably not go so well, and Sam Slick will offer to help out for 10 gold.

Sooner or later Uchly Namen will come through, and then they will have to run off, with or without the girl.

Dyslexia will shout after them about death and destruction for all from their interference.


\subsection*{Aftermath}
%----------------------
Once things have relaxed the heroes can roll int to remember the tapestry in Honorbliz' tower. Yep, the same demon. Honorbliz must have info on how it was fought the last time. This if they didn't find the notebook.
...
He won't be able to harm Dyslexia Marigt or anyone within 10sq from her, but she cannot command him completely.
...
Sam Slick can track her to the meeting place though, for a price, of course, say 5gold? Or a couple of track rolls from the Heroes might do the same, say one roll per day?

Sam Slick will sneak after her to see what is going on, and can forewarn the Heroes of the pending meeting, for a few gold of course.
...
Sneexious will have to kill her RedGuards, perhaps, if she shouts to the heroes that the demon is loose. However, this is not so difficult when you have a huge powerful demon at hand. She will of course blame the interfering heroes when questioned about the guards.
She will escape by casting invisibility if the Heroes are trying to catch her, then set the Demon after them.
...
A few houses on fire. Some holes in roofs, some houses and barns razed. Dismembered cattle and people all over the place.
Kleinshof is only 5 steps due south of the summoning site.
...
----------
force wall 10
           cast 1r 1m, size 3 +1/m, duration 5r +5/m
           2psy vs str +2/m to stop passing the blocked passage
           int 3, psy 6
force wall 10
           cast 1a 1m, size 1 +1/m, duration 2r +2/m
           psy vs str +3/m to stop passing the blocked passage
           int 3, psy 6
teleport   10
           cast 1r 1m, target 1 +1/2m, range contact.
           Teleport a willing target to any square in line of sight of the
           caster, or to any site the caster has memorised for
           teleportation and marked with a teleport marker.
           ...
           A fail-6 will teleport the target somewhere else.
           ...
           int 5, psy 5
black bolt 8
           cast 1r 1m, dam 6 +2/m, range 10 +5/m, long -3dam, penetrating
           int 7, psy 7
----------
Stun Dagger 6 dam 3 abs 8 parry-3 toparry-2
stun:         flashbang, push ams 18-range on targets with line of sight.
              draws 1 mana, requires code word activation, 1a.
money ( 2g 15s 45c)
===================================
...
sharpstaff   12 dam 7/8(6/7), penetrating 1, abs 15, parry+0/+1,
(1h/2h)         reach 1 mod-3, fast+0/+1, finesse-4
                str 5 (max +2 str bonus, extra str bonus are penetrating)
...
dex   8      m3 w6 r10 d15
con  30      stamina 30
int   8      vision 30 arc 180deg, infra soul
psy  18      mana 30
per   8      cap 12
cha   3      xp --
----------
quick        3
swat        10 dam  8, penetrating 2, knockback 3+1d4sq, min 2 dam penetrating
slash        8 dam 14, knockback 1d3sq, min 1 dam penetrating.
...
\clearpage
\phantomsection\addcontentsline{toc}{section}{05 the meeting}
\section*{05: The Meeting -- Old East Tower Ruin}
\chaptermark{the meeting}
...
The Old East Tower Ruin is 8 steps due north of The Summoning Site.


\section*{The Meeting}
%---------------------
Sneexious is waiting by the ruin for a day or so before Baron Conq arrives.

The Heroes arrive just in time to follow Sneexious up to the ruin and meet Evilnius Conq's guard. Then the Baron Conq himself emerge from the ruin when it is safe:
...
Now, command it to attack Castle Pawa. I want that annoying old man dead. Eaten preferably if possible. Command the Beast not to rest until the Baron Pawa and his Captain of the Guard both are dead. But make sure it does not destroy too much of the castle. I don't want to spend too much of Pawa's treasury having to rebuild it once I ..."rescue"... the city from its predicament. \\
...
\emph{Sneex [irritable]:} Your way of settling your debts is not always to the liking of your creditors. And seeing as I'm one of them in this case, I'm not inclined to be lenient on the details of the payment. \\
...
In the next day or two, Uchly Namen will make its way to Castle Pawa and begin the assault.
...
Uchly Namen is now commanded north east from the region south of Kleinshof, and has 14-16 step journey before he hits Merna. He stops there on the way to Castle Pawa, and wreaks havoc, eating people and cattle left and right, then irritably leaves under command influence and trudges on north east towards Castle Pawa
...
%--------------------------------------
Uchly Namen will attack in the Dead of Night. He will start by razing a farm nearby, then pound down the gate and some surrounding structures. Well inside he will start eating people and some cattle left and right until he must search out his commanded targets. It will take him hours to actually figure out who he is supposed to kill. He can't speak the language, and it takes a while before he finds a scholar and manages to torture him into translating for him from his ancient language. This scene is rather weird. He will be picking up people left and right, shouting at them \emph{DO YOU UNDERSTAND WHAT I'M SAYING? (in ancient)}, shaking them, trying again, then tossing them aside when he they just shout and scream.

Many witnesses will be able to repeat the horrible battle cries \emph{(why don't you stupid fleshlings understand me?)} of the demon when questioned, and will describe the process in detail.


\subsection*{If the Heroes are there}
%------------------------------------
The Heroes will not have a chance to reach Castle Pawa before Uchly Namen, but they can get while the battle still rages. The Heroes have a chance of limiting the destruction of Castle Pawa and it's inhabitants. If they have figured out that the spear and shield from the last banishment of Uchly Namen is kept in the great hall in Castle Pawa they can perhaps sneak during the mayhem and use it to battle the Demon. They are not skilled enough to really do any significant damage to it, but the Demon cannot easily damage the shield carrier. The demon will just whack the shield bearer away all over the courtyard until he gets tired or banged up enough to stop coming after him. But he can be annoying enough that the demon will leave earlier. Just as soon as he has killed Baron Massa Pawa and the Captain of the Guard.


\subsection*{Aftermath}
%----------------------
Once Castle Pawa is attacked the spies of Baron Conq will ride home (20 steps) during the night and early next day. By the afternoon Conq will have paid Dyslexia Marigt, and she will set off. Officially she is on her way down to the summoning site to banish the demon. However she knows she will not be able to do so. She also knows that Baron Evilnius Conq will not let her get too far with all that gold, and that he has surely sent guards/assassins after her, perhaps to kill her and take the money once the demon is gone, and surely kill her if she does not banish the demon. Her only way out is to actually get down to the summoning site and then somehow trick or kill Conq's agents.
Likely she will try to summon the demon down there and then try to have him kill the potential assailants.


Baron Evilnius Conq will ride out the next day, leading his army towards Castle Pawa, to "rescue" them from the horrible attack of the demon. It will take him about two days to ride the 21 steps north of the forest. He will leave a small guard at home in Castle Conq. Arriving at Castle Pawa he will make a pretty speech, then promptly install himself as the new ruler. Some voices will be raised about sending for Heirling Pawa, the son of Massa Pawa. Those raising the concerns will be invited to a council, from which they will never leave. Conq will then tell the cityfolk \emph{"Those heroic citizens have taken it upon themselves to find and bring back the rightful heir of the land. In the mean time I'll do my best to protect you from the foul horrors of beyond."}
...
He will now head west, along the road, towards Sleepy Cove and Castle Conq. He wants to figure out a way to kill Sneexious, and he has some ideas. He is wounded, weak, and pissed off. He will be drawn towards the necklace, to kill Sneexious, or whoever is carrying it.
...
If the heroes thwarted Dyslexia Marigt before she managed to complete the summoning ritual, which is very likley, the gate is left a bit ajar, and a pack of Grey Stalkers have managed to get through. They will ambush the heroes when they leave Castle Pawa to track down the Demon.
...
It is possible to talk to the demons if a character can speak ancient, but the characters must present something very nice for the stalkers to be interested in dealing with them. Food, magical thingies, etc, but not gold.
...
Agressive and sneaky. Send in a small one, scout, bring in the large,
...
Uchly Namen is visibly hurt, but still fights like a champ. He ruins houses, eats cattle, and swats people left and right.
If the heroes attack him with the spear and shield they might hurt him a little every now and then, but take small damages themselves as they fly left and right from his powerful attacks.
...
\subsection*{Aftermath}
%----------------------
Bling SwordSlash gets 200 gold for slaying the Demon. Sleepy Cove and the other villages pool their money. The Heroes gets nothing of course, since they were saved by Bling SwordSlash.

The villagers have already plundered Dyslexia's house, as well as shipment from the Trade Town. If they bring up the money, they are reminded that they were working for the witch, and might be accomplices. Especially if they push the issue about money... In the mean time they are treated well, but still has to pay for the rooms at Sleeping with the Fishes, until they have recovered enough to travel in search of new adventures.


Often in the future, the heroes will hear the ballad of Sleepy Cove, where the valiant Bling SwordSlash defeats the beast Uchly Namen in single combat, and where many lesser men have failed, he succeeds with heroic skill.
