...
%\textbf{\Huge{image\\ goes\\ here}}
\vspace{1 cm} % Vertical space
% for regular "latex" compile:
%\includegraphics[width=150mm,natwidth=50mm,natheight=64mm]{./maps/region-gm.jpg}
% for "pdflatex" compile:
%\includegraphics[width=150mm]{./maps/region-gm.jpg} %  << needs pdflatex to work
...
%\vspace{1 cm} % Vertical space
% for regular "latex" compile:
%\includegraphics[width=140mm,natwidth=100mm,natheight=100mm]{./maps/Sleepy-Cove.jpg}
% for "pdflatex" compile:
%\includegraphics[width=140mm]{./maps/Sleepy-Cove-(32+0+0).jpg}
%\includegraphics[width=140mm]{./maps/Sleepy-Cove-(100x100,16+0+0).jpg}
...
\subsection*{The Camp and the Cave}
%----------------------------------
