...
\noindent Below are small intermission adventures that are not part of the main campaign and can usually be played at any time. Insert where suitable.
...
"He waves his men to reinforce, mussst kill'im qick!"
...
The BlackPeak hools might work if they kill or assimilate the goblin bands there. The old Edwin Chromophobe dungeon should be mostly empty? A forest camp in Mernwoods or the old tower ruin in the Morewoods perhaps? The old ruin on the Moors can work, but orc warbands will come and fight them for it. They could even try to live out of the old torture dungeon in the Dread Duns... If they learn how to operate the meckanickery.
...
Things will get progressively worse and worse, until it's time to wrap up the campaign. Start having GammelTant scare them with GrimGnash horror stories a few days after Gamling has died. Have scout groups and foraging parties disappear. Then finally, if they don't gather courage themselves, GammelTant will force them to go find GrimGnash and try to kill him. Where they will certainly fail, ending the campaign.


\subsection*{General path through the campaign}

First get the players accustomed to their new goblins by having a couple of robbery fights. \hyperref[00justanotherdayattheoffice]{\texttt{00 Just Another Day at the Office}} and \hyperref[01robberygonewrong]{\texttt{01 Robbery Gone Wrong}} introduce Hjalmar Hjälte and SturSkurk, and set the Dread Prophecy of \emph{Death by GrimGnash} rolling.
...
The appendices hold a couple of warrior band suggestions. Also look to the previous campaigns in the region for inspiration. If the goblins become too strong perhaps some old player PCs can be used to form an NPC hunting squad to root out the bandits? Or perhaps Bling Swordslash or Sam Slick will hire a few knight and expert archers?
...
If the Heroes flee, perhaps SturSkurk Blue Boss takes Gamling's big 2h axe as a tropy? It also has a sales value so they wouldn't leave it behind.
...
Sooner or later some gang of hoomans is going to track the goblin bandits back to Hoom Hool. The approximate location is already known to the law, as it was previously home to another gang of goblin bandits. See the historical campaign \texttt{00 Return of Uchly Namen}, adventure \texttt{01 The Red Stone}, where the Heroes of the time are tasked to clear out the previous occupants of Hoom Hool in search for the lost Jewel.
...
Surviving a posse attack should be 10xp each plus shared oppostition xp. Burmak should be 15xp each plus shared opposition xp, and Lundqvist 20xp each plus shared opposition xp.
...
If they move willingly they just need to avoid getting ambushed when on the move and uprotected. Probably good to keep to the forests and hills as much as possible.

\textbf{Then:} find somewhere else to live. Where? SturSkurk camp is a decent spot but the Hoomans will find them there before long. Some other forest camp? Same again, the hoomans will find them. The hools in BlackPeak mountains are good spots to hide but already occupied. The Torture Dungeon in the Dread Duns is out of the way but haunted by wraiths and infested by bugs. The dungeon palace of Edwin the Chromophobe is probably still empty after the Heroes of Yore cleared it out in the earlier campaign adventure \texttt{02b Edwin the Chromophobe}?
...
GrimGnash lair is split by a bottomless chasm. The walls can be climbed at mod+3. The platforms are elevated but not high and can be climbed in 1r at mod+3 or jumped in 3ap with a successful acrobatics mod-3 or dex+jump mod-3 rolls. 

The huge northen flaming pyre vat braziers look different. Something is odd. When close (within per sq), roll per to notice that they look like they are alive and writhing. 
\begin{readoutloud}
...
Center on the northern dias is a huge pile of treasure. Closer inspection will show that it's all fake giant stone coins with thin leaf gold surface polished to a perfect glimmering sheen.
...
Strange Magic abounds in the hidden places off of the traveled routes.
...
If the Heroes still don't have it, this is a good place to have them buy 
\hyperref[xxtorturedungeon]{the treasure map to the Dread Duns, leading them to the Old Tower Ruin and the Torture Dungeon below.} 
A shop keeper or merchant can sell it to them, or an old man in the tavern. Perhaps even someone enters the tavern looking for Heroes to save his daughter who got lost in the Dread Duns?
...
\section*{XX intermission: Mountian Hools}
\markboth{mountain hools}{mountain hools}

There are more caves in the region, more goblin gangs. Perhaps one of these fine examples of prime real estate can serve for a new Hool if the old one is lost?


\subsection*{synopsis}

They scout for new Hoom Hool. In the BlackPeaks they find two possibilities.
...
Find info and stats of the mountain goblins and monsters in the \hyperref[appendixmountaingoblins]{mountian hool goblins appendix}, page \pageref{appendixmountaingoblins}.
...
The two large wolves are fircely loyal to, and protective of, GammelTant. They have stats like large wolves. She can send them to kill targets or fetch and port items. She can send them off to go fight with Gamling, and while he is leading they will follow his command and protect him until they reach half hp, at which point they will howl and both run off home to GammelTant.
...
\hyperref[00justanotherdayattheoffice]{\texttt{00 just another day at the office}} and 
\hyperref[01robberygonewrong]{\texttt{01 robbery gone wrong}}
...
leader 8, Oy! 8, synchronized 7, combat unit burmak
...
They fight cooperatively with a three or four wide phalanx line and two or three rows deep. First row is defencive, second row is agressive with reach or throw, third row throws. As soon as a front line soldier is wounded he is rotated back with switch.
...
\end{verbatim} \end{samepage} \goodbreak \begin{samepage} \begin{verbatim}
Common 8
synchronized 7, combat unit burmak
...
All Lundqvist soldiers are a combat group so the Captain can Oy! them into action at very high initiative, and boost them with high leadership. They often synchronize and have good reach with their spears and form a strong protective phalanx line, able to guard each other. This allows them to sync many spear attacks on one target at a time for certain and rapid kills. 
The entire Lundqvist force have quick parry and quick avoid, allowing them to make fast+1 (2ap) defence actions if they are beset by a high number of enemies, and they can guard each other.

If you want to make them even nastier, allow them to all have switch maneuver so they can move damaged soldiers backwards and fresh ones to the front.
...
Impressive, commanding, downright scary, Captain Lundqvist is a force to be reconed with on his own, and with his infantry groups close by he's an army mighty enough to topple kingdoms. At least small ones.

He Oy!s his units into extremely fast synchronised attacks, overwhelming most defencive techniques. He fights core with his heavy infantry, using his light spearmen to corral and funnel the enemies while the archers grind down anyone caught out in the open.
...
Leader 10, Oy! 8, synchronized 8, combat group lundqvist
sword 15, poke, swing, fancy 6, wayward strike, counter attack
intercept, opportunity
shield 13, quick parry, phalanx, guard
avoid 11, quick avoid, yield+4, dodge+4, off balance
brawl 7, throw 9
...
\end{verbatim} \end{samepage} \goodbreak \begin{samepage} \begin{verbatim}
Common 8
synchronized 8, combat group lundqvist
spear 13, slash, fancy 4, wayward strike, counter attack
intercept, opportunity
shield 11, quick parry, phalanx, guard
avoid 8, quick avoid, yield+3, dodge+3, off balance
throw 9, brawl 6
charge 6
...
intercept, opportunity
consistent 1, precise 1
shield 12, quick parry, phalanx guard
avoid 9, quick avoid, yield+3, dodge+3, off balance
throw 9, brawl 5
charge 6
...
They are accurate and merciless, sending a hailstorm of arrows down on anyone caught out in the open. If engaged in melee they switch to defencive long sword fighting faster than you can say \emph{spleen replacement}.
...
%       10        20        30        40        50        60        70        80
%-------------------------------------------------------------------------------
\phantomsection\addcontentsline{toc}{section}{appendix: torturous}
\section*{appendix: torturous}
\markboth{torturous}{torturous}
...
Whisps of terror and death. The fearful run away as soon as one gets close. Even the brave flee when they scream their icy shrill shriek. Close enough they will touch your heart and suck out your life. Doors or even walls cannot stop them.
...
Sloping up from the single entrance and with very poor ventilation the hool is a death trap. Close the entrance and start a heavy smoke fire and the ones in the hool will be dead by smoke inhalation soon enough.
...
The Spiderwitch clan lives well off of the proceeds from the wonderful spider silk cloth and clothing they produce. They can occasionally be found in the villages selling their wares and buying food, tools, and other necessities. Some of the clan members are not above stealing, but the spiderwitch will not tolerate any behaviour which can damage their relationship with the hoomans in the area. The SpiderWitch sometimes capture lost goblins, travelers, animals, or whatnot as sacrifice to the worshipped Spider Mother.
...
The spiderwitch leads her clan by the power of the Great Spider Mother. She has created a clan around herself and the massive spider monster of the cave. Apart from herself the clan is all male and functions as her own harem. She will not tolerate any female Heroes staying in her cave. Any high charisma male Heroes are very welcome, to the point where she might choose to kidnap them if she can.

Repeated application of her paralysing poison over a week or so breaks the targets mind (permanent psy-3) and bends him to her will. Roll against con, for at least three successes, one application per day.
...
%todo add image of spider token 3x3 plus placement of eight legs when tucked or stretched
...
dex  7                    m4 w6 r12 d18
con 15                    vision 15 dusk 235, vibration sensestamina -
int  7                    mana 4
...
The Heroes got to about 500xp in the end, but very little good gear. A few +30-50\% abs weapons, one Hero in full plate and heavy 2h axe, one OP misbalanced (\texttt{dam 7/8}) legacy heavy staff. Even in the end several Heroes were fighting with damaged weapons, temporary shields, etc. \emph{That I see as success considering the tilt of this campaign.}
...
The campaign opens with four players, eight goblins and one sidekick trained giant rat. Around 90xp freshlings, highly varied builds. They get familiar with the Hoom Hool camp and cave, and with the local region map. They go through the knowledge they got from the two goblins the GamGang met and ate along the way north when fleeing the southlands. The gang has settled in at Hoom Hool over a few weeks, done one raid at Bestest Lootspot already, and scoured the woods for good eating.

Now Gamling kicks the Heroes into action and sends them off to get more food and loot. There is a small internal fight and the Heroes loose their first pet sidekick, the giant trained fighting rat. 

They bring out another giant rat sidekick and set off towards Bestest Lootspot. The expedition is expected to take around seven days.
...
Followup:\\
SturSkurk gang doesn't have any magical healing. Their wounds will heal at normal speed, so if the GamGang is quick to go on with \hyperref[02killthebandits]{\texttt{02 kill the bandits}} the opposition will still be wounded. But instead the Heroes dilly dally and delay attacking the SturSkurk camp despite GammelTant's orders.
...
With track 5 they have seen the iffygriff nest site from the BlackPeaks during their fight for New Hool (h1). So, they decide to go investigate, and pick some delicious stink-bird eggs. With only an hour or so left of the session they arrive on the ruin site.
