...
\begin{itemize}
    ...
    \item \textbf{defend hoom-hool} The Horrible Hoomans have banded together and hired some adventurers to root out the goblin clan. The Heroes must defend their Hoom Hoole cave.
...
At the start of the campaign the GamGang crowd is made up of approximately 20 goblins, including Heroes, some 10+ runts, wolves, critters, etc. If missing, 1d3 runts can be added between adventures but goblins or other hero level NPCs must be recruited. Replacement Heroes are assumed to walk in from the woods, found in the villages, etc. They can be long lost cousins, expeditionary members, returning hunters or traders, and so on.

The whole gang, including heroes, require ca 15 "day's food" each day. The gang can forage and hunt for up to 50\% of that but Gamling and GammelTant will get angry if they don't have enough to eat and will sooner or later start cooking runts and goblins. This can include any Hero who seriously fails a task or missions, or those who irritate Gamling or GammelTant.
...
The exceptions to the tight purse strings are: money for food when the the larder is empty and weapons and armour for the Revenge Warband after Gamling has been killed.
...
They then manage to pursuade the orc boss to stand in as sexual substitute for the deceased Gamling, and thus getting GammelTant in a much better mood when they arrive back to Hoom Hool without any new loot.
...
They approach when most of the bandit gang is asleep. They manage to pursuade the watch guard at the mouth of the cave to join them with promises of women and loot. Then they attack into the cave. 8 goblins around 150xp easily take control of the west part of the cave, forming a strong defensive line.
...
Assuming an average around 10-20x "one day's food" per day and that 5 day's simple food costs 1c, it costs 2-4c per day to keep the gang fed if they buy all their food.
