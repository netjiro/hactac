...
% blkblt1  =0 +2p                                 r10, ppp, 1/r
% blkblt2  +3 +5p                                 r10, ppp, 1/2r
% shkblt1  =0 +2p                                 r15, ppp, 1/r
% shkblt2  -1 +1p                                 r20, ppp, 1/2r
% frcblt3  -1 =0p                                 r10, p1,  3ap
% frcblt3  -3 -1p                                 r10, p2,  3ap
...
% ? even at long times
% 
% treat penetrating as dam+2 on average
% 
...
% area effect         dam-2 per radius+1
% 
% 
% int 4 as base for normal complexity
...
% 
% 
% black bolts  cast 2r  !! dam 9 
%              dam psy+0 dam+/m ppp         base psy+2, dam-2 ppp, int+1
%              range 10 (med)               int,psy +0
%              range +5/m                   int+1
%              >>                           int 6, psy 9
%
% shock bolt   cast 2r  !! dam 9 fundament  range 20  dam-3 
%              dam psy+0 dam+/m ppp         base psy+2, dam-2 ppp, int+1
...
%              >>                           int 8, psy 9
% 
% force bolt   cast 3ap      (2r>>3ap : dam-3, psy+3 & int+3)  psy+2,-3=psy-1
%              range 10                     --
%              
...
%\openspellslist
%
%\spell{Ur Bolt} cast 2r 1m, 
%dam 6, 
%range 10, 
%int 4 psy 4\\
%\textit{Of Ebedan Ur, oldest of bolts, archetypical of the ancient spellcasting arts. A quick flash of clear blue light, sharp crack, smell of dry parchment. But when cast less eloquently it's well known to produce the soft quack of a drunk duck and a faint smell of old wine.}
%
%\spell{Onsager Spear} cast 3r 1m, 
%dam 10 +3/m, 
%range 10 +5/m, 
%int 6 psy 7
%
%\spellslistnote{Jeremiah Black, with no imagination and well known to never drink anything stronger than the milk of his two headed goats. Survived only by his most traditional, efficient, and horribly boring Black Bolts.}
%
...
These work similar to projectiles. The spells take target \emph{to hit} mods directly as casting mods. Target size, target movement speed, partial cover, shields in the way, shooting into melee, fire, etc all mods the spell casting roll directly. These are the same mods as a firing arrows from a bow would take. 
%TODO: think there are edge cases where this will not work right
Often the spell formation shoots in a rapid line to hit the target, or whatever gets in the way. A failed casting, which would have succeeded if not for to hit mods from cover, can be interpreted as a successfully cast spell which strikes cover or near the target instead
...
\item[strike, chock, flash:] % mental lock spells ignore cover etc, but mods by psy etc
...
%TODO: the later two classes should have reduced cost or int/psy requirements relative to the original bolt class, since that doesn't take mods.

%no mods (old style):  bolt, zap, flash, 
%arrow style:          spear, lance, dart, arrow, quarrel, missile, 
%psy modded:           strike, spark, 
