...
weak, boring, ...
otehr base stat reduction spells
...
%------------------------------
Sooner or later the powerful or rich Heroes will start fiddling towards making or buying custom magical items, weapons, armour. Probably perment magical. This should be insanely expensive. For example, a sword with a permanent black bolt, even if it takes 3r to fire and draws mana from the user, is worth in total at least 100-200xp if you add up what that character would have to spend to learn spell caster, magic, black bolt. E.g: assume he's 400xp, spell caster is 60xp, magic 3 is 18xp, black bolt 9 is 24xp, assume determined and intelligent both to 3 is needed for another 18 + 18xp, trusty armour perhaps 2*5xp, and trusty sword and shield 5+5xp, for a total of 158xp.
...
But don't make it easy for them to overflow their invetory with specialised custom magic stuff. It will be more powerful and versatile than originally thought.
