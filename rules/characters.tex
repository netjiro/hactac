...
When he saves up some more money he can switch up to a heavy longbow since he has very high strength. 
...
arms/thighs    str 2 (no str bonus)
               first three attacks do not require stamina
snap  mod-6 0a including draw if quickdraw readied in 0a (pushes mod-0)
quick mod-3 1a including draw if quickdraw readied in 0a (pushes mod-3)
quick mod-3 2a including draw if quickdraw readied in 1a (pushes mod-6)
