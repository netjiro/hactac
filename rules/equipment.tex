...
\item[dam] is the maximum damage of the weapon from a normal attack. The attacker rolls for damage in the range [1,max], where various skills affect how that is done.
...
Bows, crossbows, arbalests, and ballistas use arrows, bolts, darts, javelins, spears, or stones as ammunition. All rate of fire info below assumes that arrows are available from a readied easy to reach quiver, stuck in the ground, or similar.
...
exotic            as the regular crossbows except that they take one round
repeater type     less to reload, but at str+1, and have a bolt magasine
crossbows         which when empty must be reloaded manually taking
                  2r + 1r / bolt in the magasine.
...
Ballistas have different range tohit and damage mods:
short       mod+1 dam+10%
long        mod-3 dam-10%
very long   mod-6 dam-15%
extreme     mod-9 dam-20%


light ballista    dam 12, penetrating 4, knockback 1
                  range 24
                  carried: str 20 (no str bonus), mounted: str 3 (no bonus)
                  reload 5r, tot str 10, max 3ppl (only 1 person +3r)
...
heavy ballista    dam 20, penetrating 6, knockback 3
                  ...
                  reload 15r, tot str 20, max 5ppl (only 1 person +3r)
...
(specialty 10xp)  reload 2r (str 10 dex 10 : 1r)
                  magasine 12 (8r manual reload, 4r if dex 10)
...
when the reload mechanism is pulled.
It is rumoured that BronzeBolt paid over 300 gold for the machine and 
has to pay 1 gold per bolt. Only one craftsman can make the ammunition and it 
takes him several days to make a bundle of bolts.
\end{verbatim} \normalsize
