...
light staff         dam 2/3, abs 6, parry+1/+2, reach 1 mod-3, finesse-6/-9
1h/2h               str 3/2 (max +1/+2 str bonus)
                    2h: fast+1 if str 4 and dex 4

staff               dam 4/5, abs 8, parry+1/+2, reach 1 mod-3, finesse-6/-9
1h/2h               str 5/4 (max +1/+2 str bonus)
                    2h: fast+1 if str 6 and dex 6

heavy staff         dam 6/7, abs 10, parry+1/+2, reach 1 mod-3, finesse-6/-9
...
%ranged weapons
%--------------
%inst  mod-9 1a including draw if quick draw readied in 0a (pushes mod-1)
%snap  mod-6 1a including draw if quick draw readied in 0a (pushes mod-2)
...
%inst  mod-9 3ap if arrow quick drawn from readied quiver
%snap  mod-6 6ap if arrow drawn from readied quiver
%quick mod-3 1r (3ap fire) incl reload from accessible quiver
%shot  mod-0 2r (3ap fire) incl reload from accessible quiver
%aimed mod+1 3r (3ap fire) incl reload from accessible quiver
\small \begin{verbatim}
normal rate of fire for bows:
this includes reload from accessible quiver.
normal mod=0 2r (3ap each round, but allows no other actions)
quick  mod-3 1r (3ap each round, but allows no other actions)
aimed  mod+1 3r (3ap each round, but allows no other actions)
...
Elves produce slender weapons of very high quality. They will last longer and when rolling for weapon breakage they have half the chance of breaking (round down) and their permanent abs damage should be rounded down instead of rounded up. Elven made weapons are very rare and difficult to find outside of elven cities. Their encumbrance is -30\% of the human version, and the price is at least 5x higher than a human made. Probably closer to 5+1d5g + 5x base price.
