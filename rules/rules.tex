...
The idea is to create more tactical elements in tabletop rpg-hacknslash. Stealing some concepts from classic tabletop games like space hulk, descent, hero quest, etc, but striving towards more interesting battles, not just dps and dice rally.
...
\section*{Basic Rules}
%---------------------
We start with the bare bones basic rule set, and then expand. These very simple rules are enough to build deep tactical game play.
...
E.g: in round 5 Heroic Herman wants to attack Monster Mike and then walk 2mp. He then declares movement speed Walk and must take a mod-3 penalty to all actions that round, even if the attack happens before moving.
