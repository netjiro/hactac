...
-6: 135deg off with muptiple knees along the path\\
...
Navigating the map requires successful track rolls. Following roads is mod+6, plais mod+3, moors=0, hills and forests mod-3, mountains and deep forests mod-6.
...
I often add entry/exit boxes or borders. Cross those boundries and the Hero has left the battle and cannot return.
