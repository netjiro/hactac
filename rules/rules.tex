...
If he does not pass the roll he is unaware of the attack and cannot defend against it. Successful sneak and/or back stab by the attacker modifies the perception rolls of the target by the success diff.
...
A character regains 1 stamina at the beginning of each round regardless of declared movement and activity. A resting character regains con/3 stamina each round. Characters with low con regain extra stamina when resting slower than normal:\\
