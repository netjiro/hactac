...
%---------------------------------------
Persistent area effects, e.g. fire spells, poison clouds, etc either have an initiative of their own or inherit the initiative from the action that created them. They "act" in order of initiative just like everything else.
...
Also, anyone running into an effect area has that effect applied immediately upon entry, but only once per round even if leaving and entering multiple times in one round.
...
%--------------------------------------------
Casting spells require concentration, voice, and gestures. Spellcasting often takes several rounds and the spells take effect in the last round of casting following order of initiative.

The spell roll is subject to the highest action stack modification that the character has had during the casting period. See the "actions that take more than one round" rule above.
