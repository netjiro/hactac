...
This game is not for everyone, but it's designed to be easy to scale and tweak the complexity over a wide range. In it's simplest form it works well as a quick framework for quick gaming with very young kids. But it's primarily designed for deep tactical table top gaming set in a light hearted rpg environment.
...
Cooperation and coordination, movement, positioning, clever use of character skills, and ruthless warping of the game rules is much more important than commonly found in most monster hack games of today and yesteryear.
...
Games with a fixed balance, threat rating, etc, essentially and fundamentally says: \emph{No matter what you do, this is an approxiate balance}. For me that's a red flag and a symptom of shallow game design.
...
Some spells with duration do not require any psy to keep active, while others can require several psy, or one or more int, or str, con, dex. Some burn stamina or mana, etc.
