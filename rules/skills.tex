...
\skill{Skill scf 1.5 "quick shot":} reduces rapid fire snap and quick shot penalties by one for each skill level.
...
\skill{Maneuver (cost 30) "fast defence":} for faster avoid, parry, deflect, etc defence actions. The defence costs 1ap less than normal (for 3ap and slower normal defence actions), comes with mod-3, and costs 1 stamina. Yield and dodge have the same bonuses with fast defence as with normal defence actions.
