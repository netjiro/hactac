...
Knife is a limited variant of the sword skill aimed at smaller lighter blades. Blade weapons dam $\leq$3 are the primary use, with no mods. Blade weapons with damage 4 have mod-1, while damage 5 and 6 have mod-2. All heavier have mod-3.
...
Careful swimming: 1sq/r mod+3, requires $\leq$str encumbrance.\\
Swimming speed is swim/3 round down sq/r, but reduced for \\
