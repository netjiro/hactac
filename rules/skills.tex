...
\skill{Skill scf 4.0 "weapon master":} is the dude who knows how to handle just about any weapon imaginable, including unarmed combat, melee and ranged weapons.
...
The doppel cap, or the actions combined within doppel, can also be focus shifted like normal actions.


\skill{Skill scf 1.5, 2.0, 2.5, ... "trippel, quippel, peppel, etc":} sililar to "triple, quadruple, etc", but based on the "doppel" base functionality.
...
\skill{Maneuver (cost 10) "heavy strike":} costs +2ap for normal or slower weapons and +1ap for fast or vfast weapons, and is mod-1, toavoid+1, +33\% dam. Takes one extra stamina.


\skill{Maneuver (cost 10) "massive strike":} costs +3ap for normal or slower weapons and +2ap for fast or vfast weapons, and is mod-1, toavoid+2, +50\% dam. Takes one extra stamina.
