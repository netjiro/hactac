...
First roll for the backstab. If the backstab fails, resolve the action reverts to a normal attack, still costing the extra +1ap but giving no bonus damage.\\
...
\skill{Maneuver (cst 10) "SlowMo":} is the visually sooo cool technique of taking actions in a well coreographed and impressively slooow motion. Declare 3ap less than base maximum ap to get a mod+1 to all actions for the round. All in impressive Slow Motion.
