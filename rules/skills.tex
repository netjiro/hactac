...
\skill{Manuver (cost 5) "faceplant":}
The hero can take one extra step beyond declared movement by throwing himself on the ground and going prone. The maneuver is available even if the character is already off balance.
...
\skill{Maneuver (cost 20) "fast defence":} for faster avoid, parry, deflect, etc defence actions. The defence costs 1ap less than normal (for 3ap and slower normal defence actions), comes with mod-3, and costs 1 stamina. Yield and dodge have hte same bonuses with fast defence as with normal defence actions.
...
\skill{Maneuver (cost 30) "riposte":} The Hero can make something similar to a counter attack but using only one weapon, at a cost of one extra ap above the usual defence/attack ap, one extra stamina above the usual cost of the attack, taking mod-3 to both the parry and attack rolls, and the attack is dam 75\%.


\skill{Maneuver (cost 5) "strength bonus":} The Strong Hero can use extra strength above the weapon requirement to do extra damage or penetration depending on the weapon stats. For each +3 excessive strength he gets damage +1.
