...
%TODO: This part made sense somehow at some time, but I can't see it right now, check later:
...
%TODO: perhaps lvl 3 should be 5 dice, average ca 84%
...
\skill{Maneuver (cost 20) "quick defense":} is a faster than normal avoid/parry/deflect but is more difficult. It is fast+1 mod-3. It costs 1 stamina extra.
...
%TODO: rewrite after stamina change
...
%\skill{Maneuver (cost 10) "puny metal strength":}
\skill{Maneuver (cost 10) "stronk tank":} 
...
This gives a lot of flexibility for the strong. Note that it is possible to buy just the cost 5 flexible muscles to level 0 if you only want the 1str/ap or full round ability withtout the 1stam 0ap roll option.
...
\skill{Ability cost 20xp, ccf 1.2 "unfazed":} The character can make as many 45 or 90deg free facing changes per round as his level of unfazed, ignoring initiative. Changing facing is a free instant interrupt action.\\
Each additional level of unfazed costs +10xp.


\skill{Ability cost 10xp, ccf 1.2, scf 4.0 "gut feeling":} Before every new session/day/dungeon the character can roll and store a number of rolls equal to his level of gut feeling. These can then be used instead of making a new roll when one is called for. Each stored roll can only be used once. \emph{Storing} a roll costs no xp, but \emph{using} a gut feeling stored roll costs 1xp. Gut feeling is an instantaneous 0ap interrupt effect.
