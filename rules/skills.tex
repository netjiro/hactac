...
\skill{Skill scf 0.5 "disengage":} allows for the character to make a safer movement \emph{out} of opponent's weapon reach modifying incoming attacks in response to the movement. The level of disengage directly modifies the opponent's attack against the disengaging target.
...
It's only the first incoming attack directly following the movement that is modified. E.g: Moving Morgan engages Stand-Still-Steve, attacks but misses, and then his engage 4 gives SSS mod-4 tohit when he immediately reacts. But if MM had hit and SSS parried, the next attack from SSS would not be modified by MM engage.
...
Declare to make the next attack count, and how, before rolling the attack. A declared make it count attack must be made regardless of the outcome of the make it count roll. A successful roll will add the success diff as damage to the weapon damage, before the final damage roll. %The make it count roll is modified by ams as usual. -- stop writing this, it's declared in the beginning as norm.
...
To have faster give \& receive handovers the Hero can dedicate a quickdraw slot for "give \& recieve" to make it a non-roll 3ap action. %relay handover
...
Detailed specifik knowledge on person: mod-3\\
...
success+0 : the damage roll is 100\% + normal damage roll, min 5+roll \\
good success+3 : the damage roll is 200\% + normal damage roll, min 10+roll \\
very good success+6 : the damage roll is 300\% + normal damage roll, min 15+roll \\
perfect success+9 : the damage roll is 500\% + normal damage roll, 20+roll
