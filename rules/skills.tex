...
Declare to make the next attack count, and how, before rolling the attack. A declared make it count attack must be made regardless of the outcome of the make it count roll. A successful roll will add the success diff as damage to the weapon damage, before the final damage roll. The make it count roll is modified by ams as usual.
...
\skill{Maneuver (cost 50) "assault step":} allows for the character to take one extra movement point per round together with, but before, an attack action, after his original movement has already been used up. This does not force the character to go off balance, but it costs two stamina.
...
lvl  5  costs  75 \\
lvl  6  costs 100 \\
lvl +1  costs +30 for 7-9, +50 for 10-12.
...
Tiny characters are limited to slugger 3, small to slugger 6, normal to 9, large to 12.
